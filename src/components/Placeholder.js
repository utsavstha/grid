...
const Placeholder = ({ visibility }) => {
    if (visibility) {
        return (
            <div className="flex flex-col max-w-sm sm:max-w-lg m-2">
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" stroke="currentColor" strokeWidth="1" className="text-orange-400 px-32" viewBox="0 0 20 20">
                ...
                <p className="text-center text-gray-800">Drag image file (1024 x 1024)</p>
            </div>
        );
    } else {
        return null;
